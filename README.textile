...
<pre>
AnyAgent::Application.config.secret_token = '...some really long, random string...'
</pre>
...
The figaro gem version 0.5.0 has a bug and can't run @rake figaro:heroku@.

Set environment variables directly on Heroku with @heroku config:add@.
