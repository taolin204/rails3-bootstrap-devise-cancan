...
describe IntervieweesController do
  ...
  describe "GET index" do
    it "assigns all interviewees as @interviewees" do
      ...
      assigns(:interviewees).should eq([interviewee])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested interviewee as @interviewee" do
      ...
      assigns(:interviewee).should eq(interviewee)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new interviewee as @interviewee" do
      ...
      assigns(:interviewee).should be_a_new(Interviewee)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created interviewee as @interviewee" do
        post :create, {:interviewee => valid_attributes}, valid_session
        assigns(:interviewee).should be_a(Interviewee)
        assigns(:interviewee).should be_persisted
      end

      it "redirects to the created interviewee" do
        post :create, {:interviewee => valid_attributes}, valid_session
        response.should redirect_to(Interviewee.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved interviewee as @interviewee" do
        ...
        Interviewee.any_instance.stub(:save).and_return(false)
        post :create, {:interviewee => { "first_name" => "invalid value" }}, valid_session
        assigns(:interviewee).should be_a_new(Interviewee)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested interviewee" do
        interviewee = Interviewee.create! valid_attributes
        # Assuming there are no other interviewees in the database, this
        # specifies that the Interviewee created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Interviewee.any_instance.should_receive(:update_attributes).with({ "first_name" => "MyString" })
        put :update, {:id => interviewee.to_param, :interviewee => { "first_name" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the interviewee" do
        interviewee = Interviewee.create! valid_attributes
        put :update, {:id => interviewee.to_param, :interviewee => valid_attributes}, valid_session
        response.should redirect_to(interviewee)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the interviewee as @interviewee" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Interviewee.any_instance.stub(:save).and_return(false)
        put :update, {:id => interviewee.to_param, :interviewee => { "first_name" => "invalid value" }}, valid_session
        assigns(:interviewee).should eq(interviewee)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the interviewees list" do
      interviewee = Interviewee.create! valid_attributes
      delete :destroy, {:id => interviewee.to_param}, valid_session
      response.should redirect_to(interviewees_url)
    end
  end
